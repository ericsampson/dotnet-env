...
namespace DotNetEnv
{
    public class LoadOptions
    {
        ...
        public int  MaxTraverseDepth { get; }
        private const int MaxTraverseDepthDefault = 1000;

        public LoadOptions(
            bool setEnvVars = true,
            bool clobberExistingVars = true,
            bool onlyExactPath = true,
            int maxTraverseDepth = MaxTraverseDepthDefault
        ) {
        ...
        public LoadOptions(
            ...
            MaxTraverseDepth = maxTraverseDepth ?? old.MaxTraverseDepth;
        }
        ...
        public static LoadOptions MaxTraverseDepth (LoadOptions options = null) =>
            options == null ? DEFAULT.MaxTraverseDepth() : options.MaxTraverseDepth(MaxTraverseDepth);
        ...
        public LoadOptions WithMaxTraverseDepth (int maxTraverseDepth = MaxTraverseDepthDefault) => new LoadOptions(this, onlyExactPath: false, maxTraverseDepth: maxTraverseDepth);
